...
class TestHexMuZero(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.config = DotDict.from_json("../Configurations/MuZeroConfigs/boardgames.json")
...
class TestTreeSearch(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Setup required for unit tests.
        print("Unit testing CWD:", os.getcwd())
        self.config = DotDict.from_json("../Configurations/MuZeroConfigs/singleplayergames.json")
